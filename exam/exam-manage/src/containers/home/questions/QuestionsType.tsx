        ...
        columns: [
            ...
            },
            {
                ...
                render: (text: any, record: addUpdate) => (
                    <Space size="middle">
                        <Popconfirm placement="top" title="确定要删除？" onConfirm={() => { this.confirm(record) }} okText="确定" cancelText="取消">
        ...
        return (
            <div className="questionsType">
                ...
                <div className="questionsType_main">
                    ...
                    <Table columns={this.state.columns} dataSource={this.state.QuestionsList} pagination={false} />
                </div>
            </div>
        );
    }
